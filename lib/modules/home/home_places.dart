      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            offerLocationtext(textright: 'Popular Location', textleft: 'See all'),
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            scrollDirection: Axis.horizontal,
            itemBuilder: (BuildContext context, int index) {
              return popular(imagePath: populars[index].imagepath, locationName: populars[index].locationName,
                  address: populars[index].address, kilometre: populars[index].kilometre
            ...
            offerLocationtext(textright: 'Best offers', textleft: 'See all')
